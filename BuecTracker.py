...
#Singleplayer games:
gamePointsByCurrentRankings("data/TFT/TFT_Week"+week+".csv", "data/TFT/TFT_week"+week+"_currentRankings.csv", doNothing, False, False, True)


#Smash
gamePointsByCurrentRankings("data/Smash/Teams/Smash/Teams_Week"+week+".csv", "data/Smash/Teams/Smash/Teams_week"+week+"_currentRankings.csv", doNothing, False, False, False,  True, True)
...
temp = temp.rename(columns={"Points": "Smash (Teams)"})
temp = temp.rename_axis( index = "University" )
totalPointsByCurrentRanking = totalPointsByCurrentRanking.merge(temp, how = "outer", left_on = "University", right_on = "University")
