...
week = "3"
inputs = [str("Ow/Ow_week" + "2"+ ".csv"),"R6/R6_week" + "2"+ ".csv","Dota/Dota_week" + week + ".csv", "Val/Val_week" + week + ".csv", "CS/CS_week" + week+ ".csv", "RL/RLN_week" + week+ ".csv", "RL/RLS_week" + week+ ".csv", "LOL/LOLN_week" + week+ ".csv", "LOL/LOLS_week" + week+ ".csv"]
outputs = ["/Ow/Οw_week" + "2"+ "_currentRankings.csv","R6/R6_week" + "2"+ "_currentRankings.csv","Dota/Dota_week" + week + "_currentRankings.csv", "Val/Val_week" + week + "_currentRankings.csv", "CS/CS_week" + week + "_currentRankings.csv", "RL/North/RLN_week" + week + "_currentRankings.csv", "RL/South/RLS_week" + week + "_currentRankings.csv",  "LOL/North/LOLN_week" + week + "_currentRankings.csv", "LOL/South/LOLS_week" + week + "_currentRankings.csv"]
