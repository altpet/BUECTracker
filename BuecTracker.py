...
def pointsByCurrentRankings(numberOfTeams,buckets,sortedPoints):#allocates BUEC Points, given bucketed Swiss rankings
...
def gamePointsByCurrentRankings(sourceDir, outDir):#runs the pointsByCurrentRankings algorithm
