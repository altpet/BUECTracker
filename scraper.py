...
#scrapeGame("https://tournaments.nse.gg/tournaments/rocket-league-winter-22-north/stage-1#round-5328", "data/RL/North/RLN_week"+w+".csv") 
#scrapeGame("https://tournaments.nse.gg/tournaments/rocket-league-winter-22-south/stage-1#round-5330", "data/RL/South/RLS_week"+w+".csv")
#scrapeGame("https://tournaments.nse.gg/tournaments/league-of-legends-winter-22-north/stage-1#round-5326", "data/LOL/North/LOLN_week"+w+".csv") #Washington redskins to nott trent, remove 2match bye loser
#scrapeGame("https://tournaments.nse.gg/tournaments/league-of-legends-winter-22-south/stage-1#round-5327", "data/LOL/South/LOLS_week"+w+".csv")
